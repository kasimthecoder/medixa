...
export default function Navbar() {
  return (
    <nav className="mx-auto flex h-18 w-full max-w-7xl items-center gap-12 px-6 sm:px-4 sticky top-0 z-50 backdrop-blur-md bg-white/40">
      <a
        href="#"
      ...
      <div className="hidden flex-1 justify-end gap-2 lg:inline-flex">
        <InputGroup className="rounded-full shadow-sm w-64">
          <InputGroupInput
          ...
          <Button className="py-1 -mr-1 cursor-pointer px-3 rounded-full bg-[#565E74] text-xs h-9">
            Search
          </Button>
        </InputGroup>
      </div>
